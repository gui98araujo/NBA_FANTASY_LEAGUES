...
Original file is located at
    https://colab.research.google.com/drive/1hS52UqPBfTdHDUVMppFMfx9E2QNuwCrN
"""
...
# Dark theme (pure black) via CSS injection to satisfy "preta"
st.markdown(
    """
    <style>
    :root {
    ...
    .css-1dp5vir, .e1fqkh3o3, .st-emotion-cache-uhkwxv, .st-emotion-cache-1r4qj8v {
...
def parse_opponent_from_matchup(matchup: str) -> Tuple[str, str, bool]:
    """
    MATCHUP sample: 'DEN vs LAL' (home) or 'DEN @ LAL' (away).
...
if page == "Setup":
    ...
    if st.button("Let's Start"):
        st.session_state["include_playoffs"] = include_playoffs
        st.session_state["analysis_start_season"] = analysis_start
        with st.spinner("Downloading ALL player game logs (1996-97 to current). This may take several minutes on first run..."):
